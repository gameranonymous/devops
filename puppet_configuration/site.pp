...
class { 'minecraft':
  ...
  white_list_players => [ 'ntlk', 'semanticist', 'rnalexander', 'sgsabbage', 'discomcdisco', 'domdomdomdomdom', 'zeimpossibleface', 'sw17ch', 'bobolous', 'deValmont', 'SamLindenRathen', 'nedraed', 'squishy98' ],
